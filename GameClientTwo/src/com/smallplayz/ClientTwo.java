    ...
    public void run() {
        ...
        try {
            while ((responseLine = is.readLine()) != null) {
                ...
                if(responseLine.charAt(7) == '1')
                    Game.label.setLocation(returnCord(responseLine, 'x'), returnCord(responseLine, 'y'));
            }
            closed = true;
        } catch (IOException e) {
            System.err.println("IOException:  " + e);
...
class Game {
    ...
    Game() {
        ...
        label1.getInputMap().put(KeyStroke.getKeyStroke('s'), "downAction");
        label1.getActionMap().put("downAction", downAction);
        label1.getInputMap().put(KeyStroke.getKeyStroke('a'), "leftAction");
        label1.getActionMap().put("leftAction", leftAction);
        label1.getInputMap().put(KeyStroke.getKeyStroke('d'), "rightAction");
        label1.getActionMap().put("rightAction", rightAction);

        ImageIcon img = new ImageIcon("C:\\Users\\900ra\\IdeaProjects\\GameClientTwo\\client2.png");
    ...
    public class UpAction extends AbstractAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            ClientTwo.os.println(label1.getX() + "      " + label1.getY() + "      ");
        }
    }
